...
NewAlgorithm | bool | default false | If this is true, a new alogrithm is used that makes higher tonnage drops significantly more expensive.
Drop Cost = (Lance Drop Weight - freeTonnageAmount) * (Lance Drop Weight - freeTonnageAmount) * cbillsPerTon / freeTonnageAmount
